package com.scalapractices._02_arithmetic
...
class P36Test extends FunSpec with Matchers {
  ...
  describe("P36 Spec") {
    ...
    it(
      "should produce a list of goldbach compositions where both primes are greater than 50") {
